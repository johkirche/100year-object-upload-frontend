<script lang="ts" setup>
  ...
  import { MenuIcon, LogOut, FileText, UploadIcon, QrCode } from 'lucide-vue-next'
        ...
        <CommandList>
          ...
          <CommandGroup>
            <CommandItem
              ...
              :class="{
                'bg-accent': isItemActive(item),
                'hover:bg-accent hover:cursor-pointer': !isItemActive(item),
                'hover:text-red-500': item.hoverTextColor === 'text-red-500'
              }"
            >
