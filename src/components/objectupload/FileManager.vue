            ...
            function attemptUpload() {
                ...
                function handleError(errorMsg: string) {
                    ...
                    if (attempt < MAX_RETRIES - 1) {
                        ...
                        reject(
                            new Error(
                                `Fehler beim Hochladen nach ${MAX_RETRIES} Versuchen: ${errorMsg}`
                            )
                        )
                    }
                }
                ...
                try {
                    ...
                    handleError(
                        `Error sending request: ${e instanceof Error ? e.message : String(e)}`
                    )
                }
            }
...
<template>
    <div class="file-manager">
        ...
        <div
            v-if="error"
            class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded my-6"
        >
            {{ error }}
        </div>
                ...
                >
                    ...
                    >
                        <img
                            ...
                            class="h-full w-full object-cover rounded mb-2"
                        />
                    </div>
                    <div
                        v-else
                    ...
                    >
                        ...
                        <p class="mt-2 text-xs text-gray-600 text-center break-all">
                            {{ fileItem.file.name }}
                        </p>
